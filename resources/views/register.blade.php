    ...
    <div class="max-w-6xl mx-auto">
        <div class="grid md:grid-cols-2 gap-6 items-start">
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <div class="space-y-3 mb-4">
                    ...
                    <p class="text-sm text-gray-700 leading-relaxed">
                        Tu <strong>asistente digital personalizado</strong> que te acompaña en cada paso de tu viaje emprendedor.
                    </p>

                    <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2 mt-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--cf-green)">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        Nuestro Objetivo
                    </h3>
                    <p class="text-sm text-gray-700 leading-relaxed">
                        Impulsar a jóvenes bolivianos a crear y escalar negocios con <strong>impacto social, económico y ambiental</strong>.
                    </p>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
                ...
                <form id="registerForm" action="{{ route('api.register') }}" method="POST" class="space-y-3">
                    @csrf
                    ...
                    <button 
                        type="submit"
                        class="w-full text-white font-bold text-base py-3 px-6 rounded-full shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center gap-2"
                        style="background: var(--cf-green);">
                        <span>Crear cuenta</span>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: #fff">
                ...
                <p class="text-center text-xs text-gray-600 mt-4">
                    ¿Ya tienes cuenta? 
                    <a href="{{ url('index.php/login') }}" class="font-bold hover:underline" style="color: var(--cf-green)">Inicia sesión</a>
                </p>
            </div>
    ...
    document.getElementById('registerForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Redirigir a clasificación de emprendimiento
